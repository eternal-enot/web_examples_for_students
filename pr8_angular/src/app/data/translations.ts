...
export interface SiteTranslation {
  ...
  backHome: string;
  pageTitleIndex: string;
  pageTitleContacts: string;
  projects: ProjectItem[];
}

export const TRANSLATIONS: Record<Lang, SiteTranslation> = {
  uk: {
    heroTitle: 'Ілля',
    heroText:
      'Люблю створювати зручні та зрозумілі вебсторінки, працювати з інтерфейсами та поступово розвиватися у frontend-розробці.',
    ...
    aboutText:
      'Люблю фільми студії A24, фотографувати на аналогову плівку, кататися на велосипеді та програмувати. Найбільше цікаво поєднувати аналітичне мислення з візуально чистими веб-інтерфейсами.',
  ...
  en: {
    heroTitle: 'Illia',
    heroText:
      'I enjoy creating clear and convenient web pages, working with interfaces, and gradually growing in frontend development.',
    ...
    aboutText:
      'I enjoy A24 films, analog photography, cycling, and programming. I am most interested in combining analytical thinking with visually clean web interfaces.',
